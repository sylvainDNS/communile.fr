...
- **FR-012**: La section DOIT afficher des repères d'orientation vérifiés : les deux églises encadrant le lieu et le nom de l'arrêt de transport en commun le plus proche.
...
- **Deux sections plutôt qu'une** : l'epic prévoit deux sections distinctes (T013, T014). Elles sont conservées distinctes — la boutique relève de l'éditorial, les infos pratiques du factuel — et se suivent immédiatement pour satisfaire le parcours unique de l'US3.
